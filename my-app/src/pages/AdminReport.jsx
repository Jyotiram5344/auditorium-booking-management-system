...
const AdminReport = () => {
  ...
  const downloadPDF = () => {
    ...
    try {
      ...
      doc.setFontSize(16);
      doc.text("Admin Bookings Report", 40, 30);
      ...
      <div className="flex-1 overflow-x-auto px-2 md:px-6 mb-6">
        {loading ? (
          ...
          <div className="overflow-x-auto bg-white rounded-lg shadow border border-purple-100">
            <table className="min-w-[1200px] text-sm text-left text-gray-600">
              ...
              <tbody>
                {filtered.map((b, i) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2">{b.attendees}</td>
                    <td className="px-4 py-2">{b.collaboration}</td>
                    <td className="px-4 py-2 break-words">{b.description}</td>
                    <td className="px-4 py-2">
                      <span
